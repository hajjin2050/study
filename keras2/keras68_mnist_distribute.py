...
model = Sequential()
model.add(Dense(10, input_shape=(16, 28, 28 ), activation='relu'))
model.add(Flatten())
...
strategy = tf.distribute.MirrroredStrategy(croess_devise_ops = \
           tf.distribute.HierarchicalCopyAllRedcue()
           )
