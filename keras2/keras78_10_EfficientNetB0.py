...
file_path = 'C:/study/modelpath/checkpoint_78_10_efficientnetb0.hdf5'
...
model2 = load_model('C:/study/modelpath/checkpoint_78_10_efficientnetb0.hdf5')
loss2, acc2 = model2.evaluate(x_test, y_test, batch_size=64)
print("Best Loss : ", loss2)
print("Best acc : ", acc2)

# Best Loss :  1.0650382041931152
# Best acc :  0.8270999789237976