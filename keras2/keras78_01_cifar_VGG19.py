...
file_path = 'C:/study/modelpath/checkpoint_78_01.hdf5'
...
model2 = load_model('C:/study/modelpath/checkpoint_78_01.hdf5')
loss2, acc2 = model2.evaluate(x_test, y_test, batch_size=64)
print("Best Loss : ", loss2)
print("Best acc : ", acc2)

# Best Loss :  0.7643110156059265
# Best acc :  0.7587000131607056