...
#2.MODEL
model = RandomizedSearchCV(RandomForestRegressor(), parameters,cv=kfold) #나는 svc모델을 gridsearchcv방식으로 쓰겠다
...
# start time:  01월29일_01시20분50초
# 최적의 매개변수: RandomForestRegressor(min_samples_split=5)
# 최종정답률: 0.38492207974395765
# End time:  01월29일_01시21분29초
# 걸린시간 :  0:00:38.663545