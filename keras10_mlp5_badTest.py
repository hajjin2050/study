...
'''
#loss :  700.4102783203125
mae :  20.808330535888672
RMSE :  26.465264778920126
mse :  700.4102398183502
R2 :  0.1137721516480823
'''


#3.compile
model.compile(loss='mse', optimizer='adam', metrics='mae')
model.fit(x_train, y_train, epochs=31, batch_size=6, validation_split=0.2) #=>  train_size = 0.8 --> 그 중 0.2는 16 = (16, 5)    
