...
# hist = model.fit(x_train, y_train , epochs=10, batch_size=16, validation_data=(x_val, y_val), verbose=1, callbacks=[es] )
...
#EVALUATE -2
model = load_model('../data/h5/k52_1_mnist_checkpoint.hdf5')
